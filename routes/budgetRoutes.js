...
router.post('/daily', budgetController.saveDailyBudgetPlan);
router.post('/daily/reset', budgetController.resetDailyBudgetPlan);
router.get('/daily/report/weekly', budgetController.downloadWeeklyReport);
